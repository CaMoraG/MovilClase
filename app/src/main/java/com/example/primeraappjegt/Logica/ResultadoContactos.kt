...
import com.example.primeraappjegt.modelo.ContactsAdapter
import android.Manifest
import com.example.primeraappjegt.R

class ResultadoContactos : AppCompatActivity() {
    ...
    private fun inicializar(){
        requestPermission(this, android.Manifest.permission.READ_CONTACTS, "Se necesita permiso para leer los contactos", Datos.MY_PERMISSIONS_REQUEST_READ_CONTACTS)
    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        when (requestCode) {
            Datos.MY_PERMISSIONS_REQUEST_READ_CONTACTS -> {
                //val textView = findViewById<TextView>(R.id.resultadosContactosTextView)
                var mensaje = ""
